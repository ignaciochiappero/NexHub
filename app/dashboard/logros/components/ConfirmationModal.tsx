          ...
          >
            ...
            <div className="flex justify-end space-x-4">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={onConfirm}
                className="bg-gradient-to-r from-yellow-700 to-yellow-600 hover:from-yellow-800 hover:to-yellow-700 text-white px-6 py-3 rounded-full shadow-md transition-colors duration-300 flex items-center text-lg"
              >
